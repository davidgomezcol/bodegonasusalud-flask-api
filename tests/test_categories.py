...
from flask_api.app.categories.resources.categories_resource import CategoryService, CategorySchema
from flask_api.tests.fixtures import _setup_categories


def test_get_all_categories(database, _setup_categories):
...
def test_get_category_by_id(database, _setup_categories):
...
def test_invalid_category_data(database, _setup_categories):
...
def test_get_categories_by_ids(database, _setup_categories):
